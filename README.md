...
Once the service has been started with `docker-compose up` your contracts will be deployed to the localhost:8545 RPC. When you save the contract files they will be redeployed.
